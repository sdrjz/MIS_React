...
const handleSearch = async () => {
  ...
  const handleExcelDownload = async (e) => {
    ...
    try {
      ...
      const response = await axios.get('/api/COD/DeliveredNoRRReportExcel', {
        params: filters,
        responseType: 'blob'
      });
    ...
    <div className="p-4">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <div className="flex-grow-1 text-center">
          <h3 className="report-title m-0">Delivered No RR Report</h3>
                     ...
                     <td key={colIndex}>
                      {cellValue !== '-' ? (
                       ...
                       <span
                        onClick={() => {
                          ...
                          window.open('/DeliveredNoRRDetail', '_blank'); // Ensure this route is set up in your React Router
                        }}
                      ...
                      >
                        {cellValue}
                          ...
                          cellValue // Show plain text for Grand Total
                        )
                      ) : (
                        cellValue
                      )}
